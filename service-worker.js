const CACHE = "atlante-20260712c";
const CORE = ["./","./index.html","./styles.css?v=20260712c","./app.js?v=20260712c","./manifest.webmanifest?v=20260712c","./icon.svg","./data/giappone.json","./data/filippine.json","./data/rajasthan-maldive.json"];
