const CACHE = "atlante-20260712b";
const CORE = ["./","./index.html","./styles.css?v=20260712b","./app.js?v=20260712b","./manifest.webmanifest?v=20260712b","./icon.svg","./data/giappone.json","./data/filippine.json","./data/rajasthan-maldive.json"];
