const CACHE = "atlante-20260718a";
const CORE = ["./","./index.html","./styles.css?v=20260718a","./app.js?v=20260718a","./manifest.webmanifest?v=20260718a","./icon.svg","./data/giappone.json","./data/filippine.json","./data/rajasthan-maldive.json"];
