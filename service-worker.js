const CACHE = "atlante-20260712a";
const CORE = ["./","./index.html","./styles.css?v=20260712a","./app.js?v=20260712a","./manifest.webmanifest?v=20260712a","./icon.svg","./data/giappone.json","./data/filippine.json","./data/rajasthan-maldive.json"];
