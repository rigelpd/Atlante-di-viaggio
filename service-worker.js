const CACHE = "atlante-20260711j";
const CORE = ["./","./index.html","./styles.css?v=20260711j","./app.js?v=20260711j","./manifest.webmanifest?v=20260711j","./icon.svg","./data/giappone.json","./data/filippine.json","./data/rajasthan-maldive.json"];
