const CACHE = "atlante-20260711c";
const CORE = ["./","./index.html","./styles.css?v=20260711c","./app.js?v=20260711c","./manifest.webmanifest?v=20260711c","./icon.svg","./data/giappone.json","./data/filippine.json","./data/rajasthan-maldive.json"];
